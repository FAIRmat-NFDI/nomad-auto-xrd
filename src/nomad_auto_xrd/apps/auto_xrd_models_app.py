...
filters:
  include:
    - '*#nomad_auto_xrd.schema_packages.model.AutoXRDModel'
  exclude:
    - mainfile
    - entry_name
    - combine
filters_locked:
  sections: nomad_auto_xrd.schema_packages.model.AutoXRDModel
pagination:
...
columns:
  selected:
    ...
    - data.min_angle#nomad_auto_xrd.schema_packages.model.AutoXRDModel
    - data.max_angle#nomad_auto_xrd.schema_packages.model.AutoXRDModel
    - data.num_epochs#nomad_auto_xrd.schema_packages.model.AutoXRDModel
    - entry_name
  options:
    data.min_angle#nomad_auto_xrd.schema_packages.model.AutoXRDModel:
  ...
  widgets:
    ...
    - type: histogram
      ...
      y:
        scale: linear
      x:
        quantity: data.num_epochs#nomad_auto_xrd.schema_packages.model.AutoXRDModel
    ...
    - type: histogram
      ...
      y:
        scale: linear
      x:
        quantity: data.max_angle#nomad_auto_xrd.schema_packages.model.AutoXRDModel
    ...
    - type: histogram
      ...
      y:
        scale: linear
      x:
        quantity: data.min_angle#nomad_auto_xrd.schema_packages.model.AutoXRDModel
